<template>
  <button
    ...
    <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384.971 384.971" style="enable-background:new 0 0 384.971 384.971" xml:space="preserve">
...
<script lang="ts">
  ...
  export default class Logout extends Vue {
    ...
    public logout(): void {
      ...
      // Delete user's data in indexeddb
      del(sessionId);
